...
namespace AutoMart.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private WebUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Models.WebUser)}'. " +
                    $"Ensure that '{nameof(Models.WebUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
